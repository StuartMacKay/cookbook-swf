...
/*
 * This example shows how to create a button using DefineButton. The button
 * displays a web page in a browser when clicked and also plays a sound.
 *
 * To run this example, type the following on a command line:
 *
 *     java -cp ... com.flagstone.cookbook.BasicButtonSound sound-file file-out
 *
 * where:
 *
...
public class BasicButtonSound {
    ...
    void createMovie(Movie movie, String filename)
        ...
        factory.read(new File(filename));

        /*
         * Add the sound definition and the StartSound object which is used to
         * start the sound playing.
         */

        final DefineSound sound = factory.defineSound(uid++);

        ButtonSound buttonSound = new ButtonSound(button.getIdentifier(),
                Event.RELEASE, new SoundInfo(sound.getIdentifier(),
